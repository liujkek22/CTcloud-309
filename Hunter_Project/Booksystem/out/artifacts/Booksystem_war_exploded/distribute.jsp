...
<%@ page import="booksystem.myJDBC"  %>
<html>

<head>
    <%--    <meta charset="GB2312" />--%>
    <title>图书管理-分发系统</title>
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default bootstrap-admin-no-table-panel">
                                    ...
                                    <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                        <form class="form-horizontal" action="dist" method="get">
                                            ...
                                            <div class="col-lg-3 form-group">
                                                ...
                                                <button class="btn btn-primary" id="btn_query" onclick="">查询</button>
                                            </div>
                                            <div class="col-lg-3 form-group">
